...
// provides nutritional analysis, favourites, export, feedback , community forum and help center features.
const Home = () => {
  ...
  return (
    <>
      ...
      <RecipeCarousel updateRecipesDetails={handleUpdateRecipesDetails}></RecipeCarousel>
